...
class TrainingPrograms extends Component {
  pcontent = () => {
    if (this.props.content[3].paragraphs) {
      return this.props.content[3].paragraphs.map(p => <p key={p.id}>{p.content}</p>)
    }else if (this.props.content[3].paragraphs_attributes) {
